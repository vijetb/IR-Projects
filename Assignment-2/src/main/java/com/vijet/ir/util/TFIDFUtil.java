...
public final class TFIDFUtil{
	private static final String TFIDF_RESULTS_FILE_NAME = "./scoreresults/tfidf_results.txt";
	...
	public static Map<String, QueryScore> sort( Map<String, QueryScore> map ){
		...
		Collections.sort( list, new Comparator<Map.Entry<String, QueryScore>>(){
			...
			public int compare(Entry<String, QueryScore> o1,
				...
				double qs1 = o1.getValue().getTf_idfScore();
				double qs2=  o2.getValue().getTf_idfScore();
				if(qs1==qs2)  
					return 0;  
				else if(qs1<qs2)  
					return 1;  
	...
	public static void dumpResultsToFile(Map<String, Double> docsMap, String queryNumber) throws IOException {
		File tfidfFile = new File(TFIDF_RESULTS_FILE_NAME);
		if(!tfidfFile.exists()){
